...
CAR_INITIAL_VELOCITY    = (0.0,0.0)#(22.22, 0.0)#(5.22, 0.0)
CAR_INITIAL_VELOCITY_2  = (0.0,0.0)#(22.22, 0.0)#(5.22, 0.0)
CAR_INITIAL_VELOCITY_3  = (0.0,0.0)#(22.22, 0.0)#(5.32 , 0.0)
DRONE_POSITION          = (0.0, 0.0)
DRONE_INITIAL_VELOCITY  = (0.001,0.001)#(31.11, 0.0)#(5.31, 0.0)
K_1                     = 1.1 #2
K_2                     = 0.085 #0.08
K_W                     = -1000
