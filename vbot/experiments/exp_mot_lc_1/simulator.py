...
class Simulator:
    ...
    def start_new(self):
        ...
        self.car_2 = Car(self, *CAR_INITIAL_POSITION_2, *CAR_INITIAL_VELOCITY_2, *CAR_ACCELERATION, loaded_image_rect=self.car_img_rect_2, img=CAR_IMG_2,traj=LANE_CHANGE_TRAJECTORY_2)
