...
# screen settings
SCREEN_SIZE = WIDTH, HEIGHT = 1000, 800  # 640, 480 # 800, 600
...
LANE_CHANGE_TRAJECTORY_1 = 3
LANE_CHANGE_TRAJECTORY_2 = 4
SQUIRCLE_TRAJECTORY = 5
...
X_DES = WIDTH*0.2
Y_DES = WIDTH*0.2
S_DES = 290#300#(X_DES**2 + Y_DES**2)**0.5
C_DES = HEIGHT*0.23
Z_DES = 180
Z_DELTA = 40
S_DELTA = 20
...
ELLIPSE_ESTD_FP_COLOR = (125, 125, 155)#(51, 51, 255)
ELLIPSE_ESTD_FP_COLOR_1 = (255, 1, 1)#(51, 51, 255)
...
# open
CAR_INITIAL_POSITION    = (200.0, -160.0)
CAR_INITIAL_POSITION_2  = (200.0, -130.0)
CAR_INITIAL_POSITION_3  = (180.0, -145.0)
...
K_2                     = 0.2#0.2 #0.08	# affects a_long more
K_W                     = -100
